...
between various ``Compute Capabilities''.  CUDA through the current (2.0)
Capability uses 32-bit physical addressing exclusively.
...
\appendix
\newpage
Appendix \section{\texttt{strace(2)d} CUDA binary}\label{strace}
